        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <button onclick="window.location.href='{{ url('/gestionusuarios') }}'" type="button"
                        class="btn btn-danger gestionarusuarios">GESTIONAR USUARIOS</button>
                </div>

                <div class="dropdown col-12 col-offset-2 text-center">
                    <button class="btn btn-danger opcionesdeusuario dropdown-toggle" type="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false" style="background-color: #104069;">
                        OPCIONES DE USUARIO
                    </button>
                    <ul class="dropdown-menu" id="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{ url('/cartallamada') }}">Crear Carta Llamada</a></li>
                        <li><a class="dropdown-item" href="#">Generar Gráficos</a></li>
                        <li><a class="dropdown-item" href="#">Consultar Expedientes</a></li>
                        <li><a class="dropdown-item" href="{{ url('/helpboxvideos') }}">Consultar Ayuda</a></li>
                    </ul>
                </div>
            </div>
        </div>
