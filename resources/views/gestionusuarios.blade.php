...
@section('contenido')
    <div class="container text-center" style="margin-top: 30px;">
                <button onclick="window.location.href='{{ url('/crearUsuari') }}'" class="btn btn-success" type="button"><i class="fa-solid fa-plus"></i> Crear Usuario</button>
    </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <button class="btn btn-secondary" type="button"><i class="fa-solid fa-pen-to-square"></i> Modificar</button>
                                                <button class="btn btn-danger" type="button"><i class="fas fa-trash"></i> Eliminar</button>
                                        </td>
                                        <td>
